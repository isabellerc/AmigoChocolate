...
//         setDataRevelacaoEditada(grupo?.DataRevelacao ? grupo.DataRevelacao.toLocaleDateString() : '');
...
//             }
//             const dataRevelacaoEditadaDate = new Date(dataRevelacaoEditada);
...
//                 DataRevelacao: dataRevelacaoEditadaDate,
...
//                         <TextInput
//                             style={styles.input}
//                             value={edicaoHabilitada ? (dataRevelacaoEditada instanceof Date ? dataRevelacaoEditada.toISOString() : '') : grupo?.DataRevelacao || ''}
//                             onChangeText={(text) => setDataRevelacaoEditada(text)}
//                             editable={edicaoHabilitada}
//                         />
...
// //2º codigo xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
